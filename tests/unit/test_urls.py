...
def test_set_components():
    ...
    aurl_expected = (
        "http://user:pwd@NetLoc.com:80/p1;para/p2;para?query1=arg1&query2=arg2#frag"
    )
    assert aurl_new == aurl_expected
...
def test_replace_relative_path():
    ...
    aurl_expected = (
        "http://books.toscrape.com/catalogue/category/books/romance_8/index2.html"
    )
    aurl = urls.update_relative_path(url_original, relative_path)
    assert aurl_expected == aurl
    ...
    aurl_expected = (
        "http://books.toscrape.com/catalogue/category/books/romance_7/index.html"
    )
    aurl = urls.update_relative_path(url_original, relative_path)
    assert aurl_expected == aurl
...
def test_create_url_list():
    ...
    query = "query1=arg1"
    aurl_list_expected = [
        "http://user:pwd@NetLoc.com:80/p1;para/p2;para?query1=arg1#frag"
    ]
    ...
    path = "/p3/p4"
    aurl_list_expected = [
        "http://user:pwd@NetLoc.com:80/p3/p4?query1=arg1#frag",
